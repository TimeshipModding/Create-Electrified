...
public class CreateElectrified {
    ...
    private static final NonNullSupplier<CreateRegistrate> REGISTRATE = NonNullSupplier.lazy(() -> CreateRegistrate.create(MODID)
            .creativeModeTab(() -> ModCreativeModeTab.ELECTRIFIED_TAB_1, "Create: Electrified"));
